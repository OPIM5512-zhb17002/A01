# A01
Program overview 
This program allows you to create Box Plots for California Housing dataset.
...
you can type all to get Box Plot for all columns except latitude and longitude columns, or use
the number before column header to select a specific one or type exit to stop the script from running. The generated box plot will be saved in the figs folder.
